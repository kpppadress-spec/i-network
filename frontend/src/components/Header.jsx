...
const Header = () => {
  ...
  const solutions = [
    { name: 'Office Space', path: '/office-space', icon: '🏢' },
    { name: 'Coworking', path: '/coworking', icon: '👥' },
    { name: 'Virtual Offices', path: '/virtual-offices', icon: '🌐' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            <Link to="/locations" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-red-600 transition-colors">
              Locations
            </Link>
            <Link to="/hybrid-working" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-red-600 transition-colors">
              Hybrid Working
            </Link>
          </nav>
